...
f = open(r'C:\Users\user\Downloads\TP2_AD-Django-main (1)\TP2_AD-Django-main\loads\utentes.csv', encoding='latin-1')
csvr = csv.DictReader(f, delimiter=';', quoting=csv.QUOTE_ALL)

for index, u in enumerate(csvr):
    ut = {
        'username': 'utente' + str(index),
    ...
    print(grupo)
    conn2.request("GET", f"/addgroup/{grupo['id']}/1/")
